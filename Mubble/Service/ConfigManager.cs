...
using static Mubble.Core.Func.Option;
...
namespace Mubble.Service
{
    public class ConfigManager : IConfigManager
    {
        ...
        public ConfigManager(string folder, IMubbleHost host)
        {
            _host = host;
        ...
        public static void RegisterService(IMubbleHost host)
        {
